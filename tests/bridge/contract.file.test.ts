...
describe("契约文件自检（v2）", () => {
  ...
  it("atf_upstream pin 升至 v0.7.4b0（re-pin 2026-09-22；pin＝tag commit 0cb8e1e，R-3 标签级体检）", () => {
    expect(contract).toMatch(/  tag: v0\.7\.4b0/);
    expect(contract).toMatch(/  commit_sha: 0cb8e1e41bfa6f0ef133b4d7cf6b336bfcbde30f/);
